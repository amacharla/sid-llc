      ...
      <section id="timeline" className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="relative">
            ...
            <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-orange-400 to-blue-400"></div>
            
            {/* Mobile Timeline Line */}
            <div className="md:hidden absolute left-8 top-0 w-1 h-full bg-gradient-to-b from-orange-400 to-blue-400"></div>
            ...
            {[
              ...
              <div key={index} className={`relative mb-12 md:mb-16 ${
                ...
                {/* Timeline Dots */}
                <div className="absolute left-8 md:left-1/2 transform md:-translate-x-1/2 -translate-x-1/2 w-6 h-6 bg-gradient-to-br from-orange-400 to-blue-600 rounded-full border-4 border-white shadow-lg"></div>
                
                {/* Content Cards */}
                <div className={`
                  pl-20 md:pl-0 md:w-1/2 
                  ${milestone.side === 'left' ? 'md:text-right md:pr-12' : 'md:pl-12'}
                `}>
                  <div className="bg-white rounded-2xl p-6 md:p-8 shadow-xl hover:shadow-2xl transition-shadow border border-gray-100">
                    <span className="text-orange-600 font-bold text-sm tracking-wider uppercase block mb-2">{milestone.date}</span>
                    <h4 className="text-xl md:text-2xl font-bold text-blue-900 mb-3 leading-tight">{milestone.title}</h4>
                    <p className="text-blue-600 leading-relaxed text-sm md:text-base">{milestone.description}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="space-y-8">
                  ...
                  <div className="mt-8">
                    <h4 className="text-lg font-bold mb-4 text-orange-400">Get In Touch Directly</h4>
                    <div className="flex flex-col sm:flex-row gap-4">
                      <a 
                        href="https://wa.me/12489106126?text=Hi%20Sid%20Developers,%20I'm%20interested%20in%20learning%20more%20about%20the%20Del%20Valle%20development%20project."
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold flex items-center justify-center space-x-2 transition-all duration-200 shadow-lg hover:shadow-xl"
                      >
                      ...
                      <a 
                        href="mailto:veera@sid-llc.com?subject=Del%20Valle%20Development%20Inquiry&body=Hi%20Sid%20Developers,%0A%0AI'm%20interested%20in%20learning%20more%20about%20your%20Del%20Valle%20development%20project.%0A%0APlease%20contact%20me%20to%20discuss%20partnership%20opportunities.%0A%0AThank%20you!"
                        className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold flex items-center justify-center space-x-2 transition-all duration-200 shadow-lg hover:shadow-xl"
                      >
